...
<div class=" rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
   <div class="relative z-20 h-35 md:h-65">
     <img src="{{ asset('storage/'. $users->background) }}" alt="profile cover" class="h-full w-full rounded-tl-sm rounded-tr-sm object-cover bg-cover bg-center object-center" />
     {{-- <div class="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4" >
      ...
      @if ($users->user_id != Auth::user()->id)
        @if ($isFollowing)
        <a href="{{ route('user.unfollow', $users->user_id) }}"
          class="absolute right-0 p-4 py-2 px-4 bg-grey text-white font-semibold rounded-lg m-4 hover:bg-gray-400 transition duration-300 ease-in-out">
          Followed
          </a>
        @else
          <a href="{{ route('user.follow', $users->user_id) }}"
            class="absolute right-0 p-4 py-2 px-4 bg-primary text-white font-semibold rounded-lg m-4 hover:bg-blue-500 transition duration-300 ease-in-out">
            Follow +
          </a>
        @endif
      @endif
   ...
   <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
     ...
     <div class="relative drop-shadow-2">
       <img src="{{ asset('storage/' . $users->image ) }}" alt="profile" class="h-full w-full rounded-full"/>
     ...
     <div class="mt-4">
       ...
       <p class="font-medium">{{ $users->current_job ?? 'Website Developer' }}</p>
       ...
       <div class="mt-6.5">
        ...
        <div class="flex items-center justify-center gap-3.5">
          <a href="https://facebook.com/{{ $users->userSocial->facebook }}" class="hover:text-primary" name="social-icon" aria-label="social-icon">
          ...
          <a href="https://twitter.com/{{ $users->userSocial->twitter }}" class="hover:text-primary" name="social-icon" aria-label="social-icon">
          ...
          <a href="https://linkedin.com/{{ $users->userSocial->linkedin }}" class="hover:text-primary" name="social-icon" aria-label="social-icon" >
            <svg class="fill-current" width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg" >
          ...
          <a href="https://{{ $users->userSocial->facebook }}.com" class="hover:text-primary" name="social-icon" aria-label="social-icon"
          >
            <svg class="fill-current" width="22" height="22"  viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <a href="https://github.com/{{ $users->userSocial->github }}" class="hover:text-primary"  name="social-icon" aria-label="social-icon" >
            <svg class="fill-current" width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
