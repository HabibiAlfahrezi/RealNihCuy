      ...
      <div class="w-full lg:w-2/3  p-6">
        ...
        <div class="flex justify-between">
          ...
          <div class="flex items-center mb-4">
            ...
            <div>
              <h2 class="text-2xl font-bold text-gray-900">{{ $applicants->user->profile->name }}</h2>
              <p class="text-gray-600">{{ $applicant->user->company->name ?? 'No Company' }} - {{ $applicants->user->profile->current_job ?? 'No Current Job' }}</p>
            </div>
          </div>
          <!-- LinkedIn Section -->
          <div class="mb-4">
        ...
        <div class="flex space-x-4 mb-6 mt-3">
          ...
          <div x-data="dropdown()" class="">
            ...
            <div 
                ...
                class="absolute  mt-2 w-56 bg-white overflow-hidden shadow-2xl z-20 border border-gray-200"
            >
        ...
        <div class="space-y-8">
          <div class="grid grid-cols-2 gap-8 pb-8 border-b border-borderAbu">
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="font-semibold">{{ $applicants->user->profile->userSocial->email ?? 'No Email' }}</p>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="font-semibold">{{ $applicants->user->profile->userSocial->phone ?? 'No Phone Number' }}</p>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="font-semibold">{{ $applicants->user->profile->birth_date ?? 'No Birth Date' }}</p>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="font-semibold">{{ $applicants->user->profile->expected_salary ?? 'No Expected Salary' }}</p>
          ...
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="font-semibold">{{ $applicants->user->profile->address ?? 'No Location' }}</p>
          ...
          <div class="flex items-center mt-4">
            ...
            <div class="ml-3">
              <p class="font-semibold">{{ $applicants->user->profile->work_type ?? 'No Work Type' }}</p>
        ...
        <div class="space-y-7">
          <!-- Experience Item -->
          @foreach ($applicants->user->profile->userExperience as $experience)
            <div class="flex items-center space-x-4 border-b border-borderAbu pb-7">
              <img src="{{ asset('storage/'. $experience->image) }}" alt="Company Logo" class="w-14 h-14` rounded-full" />
              <div class="flex-grow">
        ...
        <form action="{{ route('sosmed.store') }}" method="POST">
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center border rounded-md shadow-sm">
              ...
              <input type="text" name="instagram" value="{{ $applicants->user->profile->userSocial->instagram ?? '' }}" id="instagram" placeholder="Instagram" class="w-full px-3 py-2 border-gray-300 rounded-md focus:border focus:border-primary sm:text-sm">
            </div>
            ...
            <div class="flex items-center border rounded-md shadow-sm">
              ...
              <input type="text" name="github" value="{{ $applicants->user->profile->userSocial->github ?? '' }}" id="github" placeholder="GitHub" class="w-full px-3 py-2 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            ...
            <div class="flex items-center border rounded-md shadow-sm">
              ...
              <input type="text" name="facebook" value="{{ $applicants->user->profile->userSocial->facebook ?? '' }}" id="facebook" placeholder="Facebook" class="w-full px-3 py-2 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            ...
            <div class="flex items-center border rounded-md shadow-sm">
              ...
              <input type="text" name="twitter" value="{{ $applicants->user->profile->userSocial->twitter ?? '' }}" id="twitter" placeholder="Twitter" class="w-full px-3 py-2 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            ...
            <div class="flex items-center border rounded-md shadow-sm">
              ...
              <input type="text" name="linkedin" value="{{ $applicants->user->profile->userSocial->linkedin ?? '' }}" id="linkedin" placeholder="LinkedIn" class="w-full px-3 py-2 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
