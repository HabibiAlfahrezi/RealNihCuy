            ...
            <div class="w-full mx-auto">
                ...
                <div class="flex justify-between items-center mb-2 border border-borderAbu  px-4 py-4 -mt-5">
                    <div class="flex items-center flex-shrink-0 -ml-2.5 md:ml-0">
                        <div
                            class="step-indicator w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center bg-gray-200 text-gray-400">
                        ...
                        <div class="ml-2">
                            ...
                            <p
                                class="font-semibold step-description text-gray-400 text-[14px] md:text-base whitespace-nowrap">
                                Job Information</p>
                        </div>
                    </div>
                ...
                <form id="multiStepForm" action="{{ route('job.store') }}" method="post">
                    ...
                    <div class="step-content active flex flex-col gap-y-6 ">
                                ...
                                <div class="space-y-4">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="flex flex-col">
                                            <input type="text" name="title" value="{{ $pekerjaan->title ?? '' }}"
                                ...
                                <div class="space-y-4 ">
                                    <div class="grid grid-cols-2 gap-4 " x-data="{ selectedCount: {{ count($pekerjaan->type ?? []) }} }">
                                        @foreach ($types as $type)
                                            <div x-data="{ checkboxToggle: {{ isset($pekerjaan) && $pekerjaan->type->contains('id', $type->id) ? 'true' : 'false' }} }"
                                                class="border border-borderAbu px-3 py-1 rounded-lg">
                        ...
                        <div class="grid grid-cols-6 gap-y-3 md:gap-6 md:py-6 md:border-b border-gray-300">
                            <div class="grid md:grid-cols-3 col-span-6 md:col-span-2">
                                <div class="md:col-span-2">
                                    ...
                                    <p class="text-gray-600">Please specify the estimated salary range for the role. *You
                                        can leave this blank</p>
                                </div>
                            </div>
                            <div class="md:col-span-4 col-span-6 grid md:grid-cols-2">
                                <div class="relative flex flex-col">
                                    ...
                                    <input type="number" name="salary" value="{{ $pekerjaan->salary ?? '' }}"
                        ...
                        <div class="grid grid-cols-6 gap-y-2 md:gap-6 md:py-6 md:border-b border-gray-300">
                            <div class="grid md:grid-cols-3 col-span-6 md:col-span-2">
                                <div class="md:col-span-2">
                                    ...
                                    <p class="text-gray-600">Please specify the total applicant for the role. *You can leave
                                        this blank</p>
                                </div>
                            </div>
                            <div class="col-span-6 md:col-span-4 grid md:grid-cols-2">
                                <div class="relative flex flex-col">
                                    ...
                                    <input type="number" name="total_applicant" placeholder="10"
                        ...
                        <div class="grid grid-cols-6 gap-y-2 md:gap-6 md:py-6 md:border-b border-gray-300">
                            ...
                            <div class="col-span-6 md:col-span-4 grid md:grid-cols-2">
                                <div class="flex flex-col">
                                    <select class="categories form-control" id="categories" name="categories[]"
                                        multiple="multiple">
                                        @if (!empty($pekerjaanCategory))
                                            @foreach ($allCategories as $category)
                                                <!-- Menggunakan `alltechs` untuk mendapatkan semua tech yang tersedia -->
                                                <option value="{{ $category->id }}"
                                                    {{ in_array($category->id, $pekerjaanCategory) ? 'selected' : '' }}>
                                                    {{ $category->title }}
                                                </option>
                                            @endforeach
                                        @else
                        ...
                        <div class="grid grid-cols-6 gap-y-2 md:gap-6 md:py-6 md:border-b border-gray-300">
                            ...
                            <div class="col-span-6 md:col-span-4 grid md:grid-cols-2">
                                <div class="flex flex-col">
                                    <select class="skills form-control" id="skills" name="skills[]"
                                        multiple="multiple">
                                        @if (!empty($pekerjaanSkill))
                                            @foreach ($allSkills as $skill)
                                                <!-- Menggunakan `alltechs` untuk mendapatkan semua tech yang tersedia -->
                                                <option value="{{ $skill->id }}"
                                                    {{ in_array($skill->id, $pekerjaanSkill) ? 'selected' : '' }}>
                                                    {{ $skill->title }}
                                                </option>
                                            @endforeach
                                        @else
                                ...
                                <div x-data="{ switcherToggle: {{ isset($pekerjaan) && $pekerjaan->company->role === 'Premium' ? 'true' : 'false' }} }">
                                    <label for="toggle3" class="flex cursor-pointer select-none items-center">
                                        @if (Auth::user()->company->role == 'Premium')
                                            <div class="relative">
                                                <input type="checkbox" id="toggle3" name="featured" class="sr-only"
                                        ...
                                        @else
                                            <div class="relative">
                                                <input disabled type="checkbox" id="toggle3" name="featured"
                                            ...
                                            <a href="{{ route('pricing') }}"
                                                class="ml-4 text-blue-700 hover:underline">You must be Premium to use
                                                feature! </a>
                                        @endif
                                    ...
                                    <div>
                                        <div class="relative">
                                            <input
                                                ...
                                                placeholder="mm/dd/yyyy" name="expired" type="date"
                        ...
                        <div class="flex justify-end mt-4 mb-8">
                            <button type="button"
                                class="next-step px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-primary border border-transparent rounded-lg hover:bg-red-300 focus:outline-none focus:shadow-outline-purple">
                                Next Step
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="step-content hidden flex flex-col gap-y-6">
                        <div class="md:border-b border-gray-300 md:py-6">
                            ...
                            <p class="text-gray-600">Add the description of the job, responsibilities, who you are, and
                                nice-to-haves.</p>
                        </div>
                        <div class="grid grid-cols-6 gap-y-3 md:gap-6 md:py-6 md:border-b border-gray-300">
                            <div class="grid md:grid-cols-3 col-span-6 md:col-span-2">
                            ...
                            <div class="md:col-span-4 grid md:grid-cols-2 col-span-6">
                                <div class="flex flex-col">
                                    <textarea id="job-description" name="description" class="p-2 border border-gray-300 rounded-md w-full"
                                        rows="4">{{ isset($pekerjaan) ? $pekerjaan->description : old('description') }}</textarea>
                                    @error('description')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="grid grid-cols-6 gap-y-3 md:gap-6 md:py-6 md:border-b border-gray-300">
                            ...
                            <div class="md:col-span-4 grid md:grid-cols-2 col-span-6">
                                <div class="flex flex-col">
                                    <textarea id="responsibilities" name="responsibilities[]" class="p-2 border border-gray-300 rounded-md w-full"
                                        placeholder="Enter responsibilities, each on a new line" rows="4">{{ isset($pekerjaan) ? $pekerjaan->responsibilities : old('responsibilities') }}</textarea>
                        ...
                        <div class="grid grid-cols-6 gap-y-3 md:gap-6 md:py-6 md:border-b border-gray-300">
                            ...
                            <div class="col-span-6 grid md:grid-cols-2 md:col-span-4">
                                <div class="flex flex-col">
                                    <textarea id="who-you-are" name="qualification[]" class="p-2 border border-gray-300 rounded-md w-full"
                                        placeholder="Enter qualification, each on a new line" rows="4">{{ isset($pekerjaan) ? $pekerjaan->qualification : old('qualification') }}</textarea>
                                    @error('qualification')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="grid grid-cols-6 gap-y-3 md:gap-6 md:py-6 md:border-b border-gray-300">
                            ...
                            <div class="md:col-span-4 col-span-6 grid mdgrid-cols-2">
                                <div class="relative flex flex-col">
                                    ...
                                    <input type="number" name="experience" placeholder="4 Years"
                        ...
                        <div class="flex justify-between  mt-4 mb-8">
                            <button type="button"
                                class="prev-step px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-primary border border-transparent rounded-lg hover:bg-red-300 focus:outline-none focus:shadow-outline-purple">
                                Previous Step
                            </button>
                            <button type="submit"
                                class="next-step px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-primary border border-transparent rounded-lg hover:bg-red-300 focus:outline-none focus:shadow-outline-purple">Submit</button>
                        </div>
