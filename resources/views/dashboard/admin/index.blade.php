        ...
        <main>
          <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            >
              ...
              >
                <div
                  class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-red-100 dark:bg-meta-4"
                >
                  <svg
                ...
                <div class="mt-4 flex items-end justify-between">
                  <div>
                    ...
                    <span class="text-sm font-medium">Total Companies</span>
                  </div>
                ...
                <div class="mt-4 flex items-end justify-between">
                  <div>
                    <h4
                      class="text-title-md font-bold text-black dark:text-white"
                    >
                    {{ number_format($premiumRevenue, 0, ',', '.') }}
                    </h4>
            ...
            >
              <!-- ====== Chart One Start -->
              @include('dashboard.admin.chart.chart-01')
              <!-- ====== Chart One End -->

              <!-- ====== Chart Two Start -->
              @include('dashboard.admin.chart.chart-02')
              <!-- ====== Chart Two End -->

              <!-- ====== Chart Three Start -->
              @include('dashboard.admin.chart.chart-03')
              <!-- ====== Chart Three End -->
...
@section('scripts')
<script type="module" src="{{ asset('js/components/chart-01.js') }}"></script>
<script type="module" src="{{ asset('js/components/chart-02.js') }}"></script>
<script type="module" src="{{ asset('js/components/chart-03.js') }}"></script>
<script type="module" src="{{ asset('js/components/chart-04.js') }}"></script>
@endsection