<aside
  ...
  class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-white text-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0"
  ...
  >
    ...
    >
      ...
      @if (Auth::user()->prosesi === 'admin') 
        <div>
          <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2">MENU ADMIN </h3>
          ...
          <ul class="mb-6 flex flex-col gap-1.5">
            ...
            <li>
              <x-sidelink
                :active="request()->routeIs('tech')"
                href="{{ route('tech') }}"
              >
              <i class="fa-solid fa-language text-md"></i>
      ...
      @if (Auth::user()->prosesi === 'company')
        <div>
          <h3 class="mb-4 ml-4 text-sm font-medium text-dark">MENU COMPANY</h3>
          ...
          <ul class="mb-6 flex flex-col gap-1.5">
            ...
            <!-- Menu Item Profile -->
              ...
              <li>
                <x-sidelink
                  :active="request()->routeIs('dashboard.companyprofile')"
            ...
            <li>
              <a
                class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-dark duration-300 ease-in-out hover:bg-side dark:hover:bg-meta-4"
                href="#"
                @click.prevent="selected = (selected === 'Forms' ? '':'Forms')"
                :class="{ 'bg-side text-white dark:bg-meta-4': (selected === 'Forms') || (page === 'formElements' || page === 'formLayout') }"
              >
                <svg
                  class="fill-current"
                  width="18"
            ...
            <li>
              <x-sidelink
                :active="request()->routeIs('dashboard.company.job')"
                href="{{ route('dashboard.company.job') }}"
              >
                <svg
                  class="fill-current"
                  width="18"
            ...
            <li>
              <x-sidelink
                :active="request()->routeIs('dashboard.find.user')"
                href="{{ route('dashboard.find.user') }}"
              >
            ...
            <!-- Menu Item Tables -->
              ...
              <li>
                <x-sidelink
                  :active="request()->routeIs('dashboard.companyapplication')"
                  href="{{ route('dashboard.companyapplication') }}"
                >
      ...
      @if (Auth::user()->prosesi === 'user') 
        <div>
          <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2">MENU USER</h3>
          ...
          <ul class="mb-6 flex flex-col gap-1.5">
            ...
            <li>
              <x-sidelink
                :active="request()->routeIs('dashboard.userprofile')"
          ...
          <!-- Menu Item Profile -->
             ...
             <li>
              <x-sidelink
                :active="request()->routeIs('dashboard.userapplication')"
                href="{{ route('dashboard.userapplication') }}"
              >
                <svg
                  class="fill-current"
                  width="18"
            ...
            <!-- Menu Item Tables -->
             ...
             <li>
              <x-sidelink
                :active="request()->routeIs('dashboard.find.job')"
      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
            ...
            @if (Auth::user()->prosesi === 'company')  
              <li>
                <x-sidelink
                :active="request()->routeIs('dashboard.companysetting')"
            ...
            <li>
              ...
              :active="request()->routeIs('dashboard.usersetting')"
              href="{{ route('dashboard.usersetting') }}"
            >
                <svg
                  class="fill-current"
                  width="18"
...
{{--             
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-dark duration-300 ease-in-out hover:bg-side dark:hover:bg-meta-4"
              href="chart.html"
              @click="selected = (selected === 'Chart' ? '':'Chart')"
              :class="{ 'bg-side text-white dark:bg-meta-4': (selected === 'Chart') && (page === 'Chart') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-side text-white dark:bg-meta-4': (selected === 'UiElements') || (page === 'alerts' || page === 'buttons') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-side text-white dark:bg-meta-4': (selected === 'AuthPages') || (page === 'register' || page === 'login') }"
            >
              <svg
                class="fill-current"
                width="18"
    ...
    >
      <h3 class="mb-1 font-semibold text-dark">Joki with Habibi</h3>
      <p class="mb-4 text-xs text-dark">Terima Beres</p>
      <a
