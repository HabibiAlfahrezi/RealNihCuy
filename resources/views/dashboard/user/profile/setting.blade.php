        ...
        <div class="flex flex-col bg-white">
            ...
            <div class="flex justify-center md:justify-start border-b border-gray-300">
                <button id="profile-tab"
                    class="py-3 px-3 md:px-6 text-gray-600 border-b-2 border-transparent hover:text-primary hover:border-primary focus:outline-none transition-colors">
                    My Profile
                </button>
                <button id="login-tab"
                    class="py-3 px-3 md:px-6 text-gray-600 border-b-2 border-transparent hover:text-primary hover:border-primary focus:outline-none transition-colors">
                    ...
                    <div id="profile-content" class="">
                        ...
                        <div class="w-full md:grid grid-cols-6 md:py-10 md:border-b border-borderAbu">
                            <div class="col-span-2">
                                ...
                                <p>This image will be shown publicly as your profile picture, it will help recruiters
                                    recognize you!</p>
                            </div>
                                        ...
                                        <div class="md:h-32 md:w-32 mt-4 mb-2 rounded-full">
                                            @if (Auth::user()->profile->image)
                                                <img src="{{ asset('storage/' . Auth::user()->profile->image) }}"
                                                    class="w-16 h-16 md:w-full md:h-full rounded-full" alt="User" />
                                            @else
                                        ...
                                        <div class="md:w-80 border-2 border-dashed border-primary rounded-lg p-4">
                                            <label for="file-input" class="block">
                                                <div class="text-center mb-4">
                                                    <svg class="w-12 h-12 mx-auto mb-4 text-primary" fill="none"
                                                    ...
                                                    <p class="text-sm text-red-300">SVG, PNG, JPG or GIF (max. 400 x 400px)
                                                    </p>
                                                </div>
                            ...
                            <div class="space-y-4 col-span-3">
                                <div class="md:grid grid-cols-1 md:grid-cols-2 flex flex-col gap-y-4 md:gap-4 md:px-4">
                                    <div class="flex flex-col col-span-2">
                                        ...
                                        <input id="full-name" name="name" value="{{ old('name', $profile->name ?? '') }}"
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input id="phone" name="phone"
                                            value="{{ old('phone', $profile->userSocial->phone ?? '') }}" type="text"
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input id="email" name="email"
                                            value="{{ old('email', $profile->userSocial->email ?? '') }}" type="email"
                                            class="mt-1 p-2 border border-gray-300 rounded-md">
                                        @error('email')
                                            <p class="text-red-500">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input id="dob" name="birth_date" type="date"
                        ...
                        <div class="flex justify-end mb-4">
                            <button type="submit"
                                class="px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-primary border border-transparent rounded-lg active:bg-primary hover:bg-red-300 focus:outline-none focus:shadow-outline-purple">
                        ...
                        <div class="w-full md:grid grid-cols-6 py-10 md:border-b border-gray-200">
                            ...
                            <div class="col-span-3 md:px-4">
                                ...
                                <div class="flex flex-col mt-2 md:mt-0 mb-3">
                                    <label for="email" class="text-gray-700 font-medium">Update Email</label>
                        ...
                        <div class="md:grid grid-cols-6 pb-10 md:py-10 md:border-b border-gray-200 ">
                            ...
                            <div class="space-y-4 col-span-3 mt-2 md:mt-0">
                                <div class="grid gap-4 md:px-4">
                                    ...
                                    <div class="flex flex-col">
                                        <label for="new_password" class="text-gray-700 font-medium">New Password</label>
                                        <input id="new_password" type="new_password" name="new_password"
                                            class="mt-1 p-2 border border-gray-300 rounded-md">
                                        <p>Minimum 8 Characters</p>
                                        @error('new_password')
                                            <span class="text-red-500 text-sm">{{ $message }}</span>
                                    ...
                                    <div class="flex flex-col">
                                        <label for="new_password_confirmation" class="text-gray-700 font-medium">Confirm
                                            New Password</label>
                                        <input id="new_password_confirmation" type="new_password_confirmation"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:px-4">
                                    <div class="flex flex-col">
                                        ...
                                        <input id="location" name="address"
                                            value="{{ old('address', $profile->address ?? '') }}" type="location"
                                            class="mt-1 p-2 border border-gray-300 rounded-md">
                                        @error('address')
                                            <p class="text-red-500">{{ $message }}</p>
                                        @enderror
                                            ...
                                            <select class="skills form-control" id="skills" name="skills[]"
                                                ...
                                                @if (!empty($userSkill))
                                                    @foreach ($allSkills as $skill)
                                                        <!-- Menggunakan `allSkills` untuk mendapatkan semua skill yang tersedia -->
                                                        <option value="{{ $skill->id }}"
                                                            {{ in_array($skill->id, $userSkill) ? 'selected' : '' }}>
                                                            {{ $skill->title }}
                                                        </option>
                                                    @endforeach
                                                @else
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input id="position" name="highest_position"
                                            value="{{ old('highest_position', $profile->highest_position ?? '') }}"
                                            type="text" class="mt-1 p-2 border border-gray-300 rounded-md">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input id="year" name="experience_year"
                                            value="{{ old('experience_year', $profile->experience_year ?? '') }}"
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input id="languege" name="languege"
                                            value="{{ old('languege', $profile->language ?? '') }}" type="text"
                                            class="mt-1 p-2 border border-gray-300 rounded-md">
                                        @error('languege')
                                            <p class="text-red-500">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input id="work_type" name="work_type"
                                            value="{{ old('work_type', $profile->work_type ?? '') }}" type="text"
                                            class="mt-1 p-2 border border-gray-300 rounded-md">
                                        @error('work_type')
                                            <p class="text-red-500">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="flex flex-col">
                                        <label for="expected_salary" class="text-gray-700 font-medium">Expected
                                            Salary</label>
