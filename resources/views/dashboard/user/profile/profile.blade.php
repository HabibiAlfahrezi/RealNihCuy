        ...
        <main class="container mx-auto p-4 ">
            ...
            <div
                ...
                <div class="relative z-20 h-35 md:h-65">
                    <img src="{{ asset('storage/' . $profile->background) }}" alt="profile cover"
                        class="h-full w-full rounded-tl-sm rounded-tr-sm object-cover bg-cover bg-center object-center" />
                    <div class="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
                        <form action="{{ route('background.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label for="cover"
                                ...
                                <input type="file" name="background" id="cover" class="sr-only"
                ...
                <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                        ...
                        <div class="relative drop-shadow-2">
                            ...
                            <label for="profile"
                                ...
                                <form action="{{ route('profile.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <input type="file" name="image" onchange="this.form.submit()" id="profile"
                                        class="sr-only" />
                                </form>
                            </label>
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div
                            class="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-2 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                ...
                <span class="text-sm">Posts</span>
                            ...
                            <div
                                ...
                                <span class="font-semibold text-black dark:text-white">{{ $follow->followers_count }}</span>
                                <span class="text-sm">Followers</span>
                            </div>
                            <div class="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                                <span
                                    class="font-semibold text-black dark:text-white">{{ $follow->following_count }}</span><span
                        ...
                        <div class="mt-6.5">
                            ...
                            <div class="flex items-center justify-center gap-3.5">
                                <a href="https://facebook.com/{{ $profile->userSocial->facebook ?? '' }}"
                                    class="hover:text-primary" name="social-icon" aria-label="social-icon">
                                ...
                                <a href="https://twitter.com/{{ $profile->userSocial->twitter ?? '' }}"
                                    class="hover:text-primary" name="social-icon" aria-label="social-icon">
                                ...
                                <a href="https://linkedin.com/{{ $profile->userSocial->linkedin ?? '' }}"
                                    class="hover:text-primary" name="social-icon" aria-label="social-icon">
                                    <svg class="fill-current" width="23" height="22" viewBox="0 0 23 22"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="https://{{ $profile->userSocial->facebook ?? '' }}.com"
                                    class="hover:text-primary" name="social-icon" aria-label="social-icon">
                                    <svg class="fill-current" width="22" height="22" viewBox="0 0 22 22"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="https://github.com/{{ $profile->userSocial->github ?? '' }}"
                                    class="hover:text-primary" name="social-icon" aria-label="social-icon">
                                    <svg class="fill-current" width="23" height="22" viewBox="0 0 23 22"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-col lg:flex-row gap-6 mt-12">
                ...
                <div class="w-full lg:w-2/3">
                    ...
                    <p class="leading-normal text-md text-dark border-b border-borderAbu pb-7">
                        {{ $profile->description }}</p>
                    <div class="space-y-8 md:pt-7 ">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 pb-6 border-b border-borderAbu">
                            <!-- Email -->
                            <div
                                class="flex flex-col md:flex-row md:items-center items-start border border-borderAbu md:border-none p-2">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex space-x-2">
                            <button @click="$dispatch('open-modal', 'document')"
                                class="border border-borderAbu rounded-lg p-2 hover:border-primary transition-colors">
                                <i class="fa-solid fa-plus text-xl text-secondary"></i>
                            </button>
                        </div>
                    </div>
                    <div class="border-b border-borderAbu pb-4 mb-4 flex-col space-y-4">
                        @if ($profile->userDocument->isNotEmpty())
                            @foreach ($profile->userDocument as $document)
                                <div class="flex justify-between items-center ">
                                    ...
                                    <div class="flex items-center">
                                        <div class="bg-gray-100 rounded-full p-3">
                                            ...
                                            @elseif (strpos($document->document, '.doc') !== false || strpos($document->document, '.docx') !== false)
                                                <i class="fas fa-file-word"></i> <!-- Ikon untuk Word -->
                                            @elseif (strpos($document->document, '.ppt') !== false || strpos($document->document, '.pptx') !== false)
                                                <i class="fas fa-file-powerpoint"></i> <!-- Ikon untuk PowerPoint -->
                                            @elseif (strpos($document->document, '.odt') !== false)
                                                <i class="fas fa-file-alt"></i> <!-- Ikon untuk ODT -->
                                            @elseif (strpos($document->document, '.odp') !== false)
                                                <i class="fas fa-file-presentation"></i> <!-- Ikon untuk ODP -->
                                            @else
                                                <i class="fas fa-file"></i> <!-- Ikon default untuk file lainnya -->
                                            @endif
                                        </div>
                                        <p class="text-gray-700 ml-3">
                                            {{ $document->name ?? 'No Resume' }}
                                        </p>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <div class="">
                                            <!-- Tambahkan margin left untuk memisahkan tombol download -->
                                            <a href="{{ asset('storage/' . $document->document) }}" type="button"
                                                class="bg-secondary hover:bg-blue-300 transition duration-300 ease-in-out text-white font-bold p-1 rounded flex items-center">
                                        ...
                                        <div class="">
                                            <!-- Tambahkan margin left untuk memisahkan tombol download -->
                                            <a href="{{ route('document.delete', $document->id) }}" type="button"
                                                class="bg-primary hover:bg-red-300 transition duration-300 ease-in-out text-white font-bold p-1 rounded flex items-center">
                                                <div class="rounded-full p-1 ">
                            ...
                            @endforeach
                        @else
                            <p class="text-gray-700 ml-3">No Resume</p>
                        @endif
                    </div>
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            <button @click="$dispatch('open-modal', 'experience')"
                                class="border border-borderAbu rounded-lg p-2 hover:border-primary transition-colors">
                                <i class="fa-solid fa-plus text-xl text-secondary"></i>
                            </button>
                        </div>
                        ...
                        @foreach ($profile->userExperience as $experience)
                            <div class="md:flex items-start md:space-x-4 border-b border-borderAbu pb-7">
                                <div class="flex md:flex-none items-start justify-between">
                                    <img src="{{ asset('storage/' . $experience->image) }}" alt="Company Logo"
                                        class="w-16 h-16 rounded-full mb-4 md:mb-0" />
                                    <a href="{{ route('experience.delete', $experience->id) }}"
                                        class="border border-borderAbu block md:hidden rounded-lg p-2 hover:border-primary transition-colors">
                                ...
                                <div class="flex-grow">
                                    ...
                                    <div class="flex items-center space-x-2 ">
                                        ...
                                        <p class="text-gray-500">{{ $experience->start_date }} -
                    ...
                    <div class="flex justify-between items-center my-6">
                        ...
                        <div class="flex space-x-2">
                            <button @click="$dispatch('open-modal', 'education')"
                                class="border border-borderAbu rounded-lg p-2 hover:border-primary transition-colors">
                                <i class="fa-solid fa-plus text-xl text-secondary"></i>
                            </button>
                        </div>
                    ...
                    <div class="space-y-7">
                        @foreach ($profile->userEducation as $education)
                            <div class="md:flex items-start md:space-x-4 border-b border-borderAbu pb-7">
                                <div class="flex md:flex-none items-start justify-between">
                                    <img src="{{ asset('storage/' . $education->image) }}" alt="Company Logo"
                                        class="w-16 h-16 rounded-full mb-4 md:mb-0" />
                ...
                <div class="w-full lg:w-1/3 md:px-10">
                    ...
                    <div class="mb-8">
                        <div class="flex justify-between items-center   mb-4">
                            ...
                            <button @click="$dispatch('open-modal', 'social-media')"
                                class="border border-borderAbu rounded-lg p-1 hover:border-primary transition-colors">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="https://instagram.com/{{ $profile->userSocial->instagram }}"
                                            class="text-blue-500 text-sm underline">instagram.com/{{ $profile->userSocial->instagram }}</a>
                                    </div>
                                </div>
                                <!-- GitHub -->
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="https://github.com/{{ $profile->userSocial->github }}" target="_blank"
                                            class="text-blue-500 text-sm underline">github.com/{{ $profile->userSocial->github }}</a>
                                    </div>
                                </div>
                                <!-- Twitter (X) -->
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="https://twitter.com/{{ $profile->userSocial->twitter }}"
                                            class="text-blue-500 text-sm underline">twitter.com/{{ $profile->userSocial->twitter }}</a>
                                    </div>
                                </div>
                                <!-- Facebook -->
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="https://facebook.com/{{ $profile->userSocial->facebook }}"
                                            class="text-blue-500 text-sm underline">facebook.com/{{ $profile->userSocial->facebook }}</a>
                                    </div>
                                </div>
                                <!-- Twitter (X) -->
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="https://linkedin.com/{{ $profile->userSocial->linkedin }}"
                                            class="text-blue-500 text-sm underline">linkedin.com/{{ $profile->userSocial->linkedin }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="space-y-6">
                        ...
                        @foreach ($applicants as $applicant)
                            <div class="border-b border-borderAbu pb-4">
                                <img src="{{ asset('storage/' . $applicant->company->logo) }}" alt="Company Logo"
                                    class="rounded-full w-14 h-14 mb-4 mr-4" />
                                <div class="flex items-center">
                                    <div class="flex-grow">
                                    ...
                                    <button
                                        class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded capitalize">
                    ...
                    <form action="{{ route('role.store') }}" method="POST">
                        ...
                        <select name="role" onchange="this.form.submit()"
                            class="border border-borderAbu px-4 py-2 rounded text-gray-700 w-full">
                            <option {{ old('role', $profile->role == 'actively-seeking-job' ? 'selected' : '') }}
                                value="actively-seeking-job" selected>Actively Seeking Job</option>
                            <option {{ old('role', $profile->role == 'open-to-offers' ? 'selected' : '') }}
                                value="open-to-offers">Open to Offers</option>
                            <option {{ old('role', $profile->role == 'not-actively-seeking' ? 'selected' : '') }}
                                value="not-actively-seeking">Not Actively Seeking</option>
                        </select>
                    </form>
            ...
            <div class="flex-none w-full max-w-full mt-6">
                <div
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            <button @click="$dispatch('open-modal', 'project')"
                                class="border border-borderAbu rounded-lg p-2 hover:border-primary transition-colors">
                                <i class="fa-solid fa-plus text-xl text-secondary"></i>
                            </button>
                        </div>
                    ...
                    <div class="flex-auto ">
                        <div class="flex flex-wrap gap-6">
                            @foreach ($profile->userProject as $project)
                                <div
                                    class="w-full max-w-full md:mb-6 md:w-6/12 md:flex-none xl:mb-8 xl:w-3/12 border border-borderAbu shadow-lg py-4 px-6 rounded-lg bg-white">
                                    {{-- Tambahkan background untuk memastikan border terlihat jelas --}}
                                    <div
                                        class="relative flex flex-col h-full bg-transparent border-0 shadow-none rounded-2xl bg-clip-border">
                                        ...
                                        <div class="flex flex-col flex-auto pt-3">
                                            ...
                                            <div class="flex items-center justify-between mt-auto">
                                                ...
                                                <a href="{{ route('project.delete', $project->id) }}"
                                                    class="border group flex items-center justify-center border-borderAbu rounded-lg p-1 hover:border-primary transition-colors w-10 h-10">
                                                    <i
                                                        class="fa-solid fa-trash text-md text-center group-hover:text-primary"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
              ...
              hover:file:bg-indigo-100">
                ...
                <x-slot name="footer">
                    <button type="button" @click="isModalOpen = false"
                        class="w-full px-5 py-3 text-sm font-medium leading-5 text-gray-700 transition-colors duration-150 border border-gray-300 rounded-lg sm:px-4 sm:py-2 sm:w-auto hover:border-gray-500 focus:border-gray-500 focus:outline-none focus:shadow-outline-gray">
                        Cancel
                    </button>
                    <button type="submit" form="documentForm"
                        class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-indigo-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 hover:bg-indigo-700 focus:outline-none focus:shadow-outline-purple">
                        Add Background
                    </button>
                </x-slot>
            </form>
            ...
            <form action="{{ route('document.store') }}" id="documentForm" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name"
                        class="mt-1 block w-full py-2 px-3 border rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border focus:border-primary sm:text-sm border-gray-300">
                </div>
            ...
            <form action="{{ route('sosmed.store') }}" id="socialMediaForm" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center border rounded-md shadow-sm">
                        <span
                            class="inline-flex items-center px-3 text-gray-500 bg-gray-100 border-r border-gray-300 rounded-l-md">
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5.5 3A2.5 2.5 0 003 5.5v13A2.5 2.5 0 005.5 21h13A2.5 2.5 0 0021 18.5v-13A2.5 2.5 0 0018.5 3h-13zM12 7a5 5 0 100 10 5 5 0 000-10zm4.5 1a.75.75 0 01.75.75v2.5a.75.75 0 01-.75.75h-2.5a.75.75 0 01-.75-.75v-2.5a.75.75 0 01.75-.75h2.5z" />
                            </svg>
                        </span>
                        <input type="text" name="instagram" value="{{ $profile->userSocial->instagram ?? '' }}"
                            id="instagram" placeholder="Instagram"
                            class="w-full px-3 py-2 border-gray-300 rounded-md focus:border focus:border-primary sm:text-sm">
                    </div>
                    ...
                    <div class="flex items-center border rounded-md shadow-sm">
                        <span
                            ...
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M18.36 9.64a.99.99 0 00-.88-.63h-2.71v-.68c0-.35.2-.6.54-.6h2.17a.99.99 0 00.88-.63.99.99 0 00-.88-1.37h-2.17a2.65 2.65 0 00-2.66 2.65v.68H11c-.55 0-1 .45-1 1s.45 1 1 1h1.71v8c0 .55.45 1 1 1s1-.45 1-1v-8h2.71a.99.99 0 00.88-.63c.09-.31.03-.64-.17-.9l-2.25-3.4a.99.99 0 00-1.38-.26c-.26.18-.4.49-.35.8z" />
                            </svg>
                        </span>
                        <input type="text" name="facebook" value="{{ $profile->userSocial->facebook ?? '' }}"
                    ...
                    <div class="flex items-center border rounded-md shadow-sm">
                        ...
                        <input type="text" name="twitter" value="{{ $profile->userSocial->twitter ?? '' }}"
                    ...
                    <div class="flex items-center border rounded-md shadow-sm">
                        <span
                            ...
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M16 8a6 6 0 100-12 6 6 0 000 12zm-4 3a5 5 0 00-5 5v7h-4v-7a5 5 0 0110 0v7h-4v-7a5 5 0 00-5-5zm14 12v-5.5c0-3.58-1.92-5.5-5.02-5.5-2.63 0-3.8 1.61-4.46 2.73V16h-4v7h4v-5.17c0-1.18.45-2.83 1.88-2.83 1.42 0 1.94 1.28 1.94 2.94V23h4z" />
                            </svg>
                        </span>
                        <input type="text" name="linkedin" value="{{ $profile->userSocial->linkedin ?? '' }}"
                ...
                <div class="mt-4">
                    <x-slot name="footer">
                        ...
                        <button type="submit" form="socialMediaForm"
                            class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-indigo-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 hover:bg-indigo-700 focus:outline-none focus:shadow-outline-purple">
                            Add Social Media
                        </button>
                    </x-slot>
...
<x-mainModal id="experience">
    <div class="w-full">
        <x-slot name="header">
            <h2 class="text-center text-xl font-semibold mb-6 text-gray-900">Add Job Experience</h2>
        </x-slot>

        <form action="{{ route('experience.store') }}" id="experienceForm" method="POST"
            enctype="multipart/form-data">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" placeholder="Enter your job title"
                        class="mt-1 w-full border border-gray-300 rounded-lg py-2 px-4 shadow-sm focus:outline-none focus:ring-primary focus:border focus:border-primary text-sm">
                </div>

                <!-- Company Logo -->
                <div>
                    <label for="companyLogo" class="block text-sm font-medium text-gray-700">Company Logo</label>
                    <input type="file" id="companyLogo" name="image" accept="image/*"
                        class="mt-1 w-full text-gray-500 text-sm file:bg-indigo-50 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:text-indigo-700 hover:file:bg-indigo-100">
                </div>
                ...
                <div>
                    <label for="employment_type" class="block text-sm font-medium text-gray-700">Employment
                        Type</label>
                    <input type="text" name="type" id="employment_type"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" placeholder="Enter job description"
                        class="mt-1 w-full border border-gray-300 rounded-lg py-2 px-4 shadow-sm focus:outline-none focus:ring-primary focus:border focus:border-primary text-sm"></textarea>
                </div>
            </div>

            <!-- Form Actions -->
            <x-slot name='footer' class="mt-6 space-y-3">
                <button type="submit" form="experienceForm"
                    class="w-full bg-indigo-600 text-white py-2 px-4 rounded-lg hover:bg-indigo-700 focus:outline-none focus:shadow-outline-purple transition-colors">
                    Add Experience
                </button>
                <button type="button" @click="isModalOpen = false"
                    class="w-full border border-gray-300 text-gray-700 py-2 px-4 rounded-lg hover:border-gray-500 focus:outline-none focus:shadow-outline-gray transition-colors">
                    Cancel
                </button>
            </x-slot>
        </form>
...
<x-mainModal id="education">
    <div class="w-full">
        <x-slot name="header">
            <h2 class="text-center text-xl font-semibold mb-6 text-gray-900">Add Your Education</h2>
        </x-slot>

        <form action="{{ route('education.store') }}" id="educationForm" method="POST"
            enctype="multipart/form-data">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" placeholder="Enter your education title"
                        class="mt-1 w-full border border-gray-300 rounded-lg py-2 px-4 shadow-sm focus:outline-none focus:ring-primary focus:border focus:border-primary text-sm">
                </div>
            ...
            <!-- Form Actions -->
            <x-slot name='footer' class="mt-6 space-y-3">
                <button type="submit" form="educationForm"
                    class="w-full bg-indigo-600 text-white py-2 px-4 rounded-lg hover:bg-indigo-700 focus:outline-none focus:shadow-outline-purple transition-colors">
                    Add Education
                </button>
                <button type="button" @click="isModalOpen = false"
      ...
      <div class="mt-4">
          <form action="" method="POST">
              ...
              <div class="mb-4">
                  ...
                  <input type="text" name="name" id="name" class="py-2 px-3 mt-1 focus:outline-none focus:ring-primary focus:border focus:border-primary block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
              </div>
              <div class="mb-4">
                  <label for="description" class="block text-sm font-medium text-gray-700">Description</label>
                  <textarea name="description" id="description" rows="3" class="mt-1 focus:outline-none focus:ring-primary focus:border focus:border-primary block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
              </div>
              ...
              hover:file:bg-indigo-100">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="mt-1 block w-full py-2 px-3 border rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border focus:border-primary sm:text-sm border-gray-300"></textarea>
                </div>
