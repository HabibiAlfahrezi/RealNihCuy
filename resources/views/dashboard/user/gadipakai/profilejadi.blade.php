  ...
  <main class="container mx-auto p-6 ">
          ...
          <div class="mt-4">
            ...
            {{-- <div class="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]" >
              ...
              <div class="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                <span class="font-semibold text-black dark:text-white"
                  >2K</span><span class="text-sm">Following</span>
              </div>
            </div> --}}
    ...
    <div class="flex justify-between">
      ...
      <div class="flex items-center mb-4">
        <img src="{{ asset('storage/' . $profile->image) }}" alt="Profile Picture" class="w-14 h-14 rounded-full mr-4" />
        <div>
          <h2 class="text-2xl font-bold text-gray-900">{{ $profile->name }}</h2>
          <p class="text-gray-600">{{ $profile->user->company->name ?? 'No Company' }} - {{ $profile->current_job ?? 'No Current Job' }}</p>
        </div>
      </div>
      <!-- LinkedIn Section -->
      <div class="mb-4">
            ...
            <div class="flex items-start space-x-4 border-b border-borderAbu pb-7">
              ...
              <div class="flex-grow">
                <div class="flex justify-between items-center">
                  ...
                  <a href="{{ route('experience.delete', $experience->id) }}"  class="border border-borderAbu rounded-lg p-1 hover:border-primary transition-colors">
                    <img src="{{ asset('image/icon/delete.png') }}" class="w- h-6" alt="Add">
                  </a>
        ...
        <div class="space-y-7">
          @foreach ($profile->userEducation as $education)
            <div class="flex items-start border-b border-borderAbu pb-7">
              <img src="{{ asset('storage/'. $education->image)  }}" alt="University Logo" class="w-14 h-14 rounded-full mr-4" />
              <div class="flex-grow">
                <div class="flex justify-between items-center">
                  <h4 class="font-bold text-gray-800">{{ $education->title }}</h4>
                  <a href="{{ route('education.delete', $education->id) }}"  class="border border-borderAbu rounded-lg p-1 hover:border-primary transition-colors">
      ...
      <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
        ...
        <div class="flex-auto ">
          <div class="flex flex-wrap gap-6">
            ...
            <div class="w-full max-w-full mb-6 md:w-6/12 md:flex-none xl:mb-8 xl:w-3/12 border border-borderAbu py-4 px-6 rounded-lg bg-white"> {{-- Tambahkan background untuk memastikan border terlihat jelas --}}
