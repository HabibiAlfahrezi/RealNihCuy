    ...
    <div class="container mx-auto flex flex-wrap items-center">
        ...
        <div class="w-full md:w-1/2 px-4">
            <div class="flex justify-center space-x-4 mb-6 mx-auto w-full max-w-md">
                <p id="job-seeker-tab" class="font-semibold {{ $activeTab == 'job-seeker' ? 'text-blue-500' : 'text-gray-500' }} cursor-pointer">Job Seeker</p>
                <p id="company-tab" class="font-semibold {{ $activeTab == 'company' ? 'text-blue-500' : 'text-gray-500' }} cursor-pointer">Company</p>
            </div>
            ...
            <div id="job-seeker-form" class="space-y-4 {{ $activeTab == 'job-seeker' ? '' : 'hidden' }}">
                <form action="/userStore" method="post" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="full-name" name="user_name" placeholder="Enter Your Full Name" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="user_email" value="{{ old('user_email') }}" placeholder="Enter Your Email Address" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="password" id="password" name="user_password" placeholder="Enter Your Password" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="password" id="confirm-password" name="user_password_confirmation" placeholder="Confirm Your Password" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div id="company-form" class="space-y-4 {{ $activeTab == 'company' ? '' : 'hidden' }}">
                <form action="{{ route('account.companyStore') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" id="company-name" name="name" value="{{ old('name')  }}" placeholder="Enter Your Full Account Name" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        @if ($errors->has('name'))
                    ...
                    <div>
                        ...
                        <input type="text" id="company-name" name="company_name" value="{{ old('company_name') }}"  placeholder="Enter Your Company Name" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="email" id="company-email" name="email" value="{{ old('email') }}" placeholder="Enter Your Email Address" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        @if ($errors->has('email'))
                    ...
                    <div>
                        ...
                        <input type="password" id="company-password" name="password"  placeholder="Enter Your Password" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="password" id="confirm-company-password" name="password_confirmation" placeholder="Confirm Your Password" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
