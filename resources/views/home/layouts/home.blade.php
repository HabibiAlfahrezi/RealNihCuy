...
<body class="bg-putihG md:mx-16 ">
    <nav id="navbar"
        class="navbar container px-4  lg:px-4 xl:px-20 py-7  w-full flex  justify-between items-center bg-white transition-all duration-300 fixed right-0 left-0  top-0 z-50 ">
